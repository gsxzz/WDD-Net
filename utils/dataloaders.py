...
class LoadImagesAndLabels(Dataset):
    ...
    #速度太慢了
    def denoise_nl_means(self,image, h=4, hForColor=4, templateWindowSize=5, searchWindowSize=19):
        denoised_image = cv2.fastNlMeansDenoising(image, None, h, templateWindowSize,
                                                  searchWindowSize)
