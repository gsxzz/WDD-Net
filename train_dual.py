...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        # print(model.state_dict()["model.1.conv.weight"].to(device) == csd["model.1.conv.weight"].to(device),"judge")
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='/home/ilab/gnz/Yolo/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT /'models/detect/yolov9-c-1.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/steelpipe.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train_1', help='save to project/name')
