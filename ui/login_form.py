...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.widget.setGeometry(QtCore.QRect(30, 30, 650, 650))
...
"")
        ...
        # 设置窗体背景自适应
        palette.setBrush(self.label.backgroundRole(), QBrush(
                QPixmap(r"D:\bjut\pyqt5\res\image\img.png").scaled(280, 430)))
        self.label.setPalette(palette)
        self.label.setAutoFillBackground(True)  # 设置自动填充背景
...
"border-bottom-right-radius:50px;")
        ...
        self.label_4.setGeometry(QtCore.QRect(300, 100, 180, 40))
...
"padding-bottom:7px;")
        ...
        self.label_5.setGeometry(QtCore.QRect(280, 70, 220, 40))
        self.label_5.setMinimumSize(QtCore.QSize(220, 40))
        self.label_5.setMaximumSize(QtCore.QSize(220, 40))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        # self.mysql_pushButton.setGeometry(QtCore.QRect(290, 60, 200, 23))
        # self.mysql_pushButton.setMinimumSize(QtCore.QSize(200, 23))
        # self.mysql_pushButton.setMaximumSize(QtCore.QSize(200, 23))
        # font = QtGui.QFont()
        # font.setFamily("华文楷体")
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_5.setText(_translate("Frame", "钢结构焊缝缺陷智能识别系统"))
